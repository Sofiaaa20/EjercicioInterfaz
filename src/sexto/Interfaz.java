...
public class Interfaz extends JFrame implements ActionListener, MouseListener {
	...
	public Interfaz() {
		...
		contentPane.setBackground(new Color(183, 125, 135));
		...
		btnAchicar.setBounds(308, 292, 117, 29);
		...
		etiNombre.setBackground(new Color(1, 1, 1));
		etiNombre.setHorizontalAlignment(SwingConstants.CENTER);
		etiNombre.setBounds(188, 82, 117, 38);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnEsquina) {
			etiNombre.setLocation(360,0);
			
		}else if(e.getSource() == btnCentro) {
			etiNombre.setLocation(190,50);
			
		}else if(e.getSource() == btnAchicar) {
			etiNombre.setSize(10,10); 
